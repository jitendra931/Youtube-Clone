    ...
    <div className="play-video">
      ...
      <div className="play-video-info">
        ...
        <div>
          <span>
            <img src={like} alt="" />
            {apiData ? value_converter(apiData.statistics.likeCount) : "2k"}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="vid-description">
        ...
        <hr />
        <h4>
          {apiData ? value_converter(apiData.statistics.commentCount) : 250}{" "}
          Comments
        </h4>
        {commentData.map((itme, index) => {
          return (
            <div key={index} className="comment">
              <img
                src={itme.snippet.topLevelComment.snippet.authorProfileImageUrl}
                alt=""
              />
              <div>
                <h3>
                  {itme.snippet.topLevelComment.snippet.authorDisplayName}{" "}
                  <span>1 day ago</span>
                </h3>
                <p>{itme.snippet.topLevelComment.snippet.textDisplay}</p>

                <div className="comment-action">
                  <img src={like} alt="" />
                  <span>
                    {value_converter(
                      itme.snippet.topLevelComment.snippet.likeCount
                    )}
                  </span>
                  <img src={dislike} alt="" />
                </div>
